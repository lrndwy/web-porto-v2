...
// Taxonomy forms collect only the name; the slug is generated server-side.
export const blogCategoryFields: FieldDef[] = [
 { name: 'name', label: 'Name', type: 'text', placeholder: 'Engineering' },
 { name: 'description', label: 'Description', type: 'textarea', rows: 3 },
]

export const blogCategoryBlank = {
 name: '',
 description: '',
}

export const blogTagFields: FieldDef[] = [
 { name: 'name', label: 'Name', type: 'text', placeholder: 'Nuxt' },
]

export const blogTagBlank = {
 name: '',
}
